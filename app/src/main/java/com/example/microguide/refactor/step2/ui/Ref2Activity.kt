package com.example.microguide.refactor.step2.ui
...
import com.example.microguide.refactor.step2.presentation.Ref2ViewModel
import com.example.microguide.refactor.step2.presentation.ScreenState
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class Ref2Activity : RefActivity() {

    companion object {

        fun start(context: Context) {
            context.startActivity<Ref2Activity>()
        }
    }

    private val viewModel: Ref2ViewModel by viewModels()
    ...
    private fun setupRecyclerView() = with(binding) {
        val dividerDecoration = DividerItemDecoration(this@Ref2Activity, RecyclerView.VERTICAL)
